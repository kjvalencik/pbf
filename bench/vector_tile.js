...
Tile.Value._readField = function (type, tag, obj, pbf) {
    ...
    else if (tag === 5) obj.uint_value = pbf.readVarint(true);
...
Tile.Feature._readField = function (type, tag, obj, pbf) {
    ...
    else if (tag === 2) pbf.readPackedVarint(type, obj.tags, true);
    else if (tag === 3) obj.type = pbf.readVarint();
    else if (tag === 4) pbf.readPackedVarint(type, obj.geometry, true);
};
...
Tile.Layer._readField = function (type, tag, obj, pbf) {
    if (tag === 15) obj.version = pbf.readVarint(true);
    ...
    else if (tag === 5) obj.extent = pbf.readVarint(true);
};
